...
export const metadata: Metadata = {
  title: "The Boutique Hotel - Luxury Accommodations & Personalized Service",
  description: "Experience exceptional hospitality at The Boutique Hotel. Elegant rooms, premium amenities, and personalized service in the heart of the city.",
  keywords: "boutique hotel, luxury accommodation, premium hotel, personalized service, elegant rooms",
  openGraph: {
    title: "The Boutique Hotel - Where Luxury Meets Comfort",
    description: "Experience exceptional hospitality with elegant accommodations and personalized service in our boutique hotel.",
    siteName: "The Boutique Hotel",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32m5rRdd38TAyU0DZCqvrl288SF/uploaded-1763478427165-73xt91qv.jpg",
        alt: "The Boutique Hotel exterior"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",
    title: "The Boutique Hotel - Luxury Accommodations",
    description: "Experience exceptional hospitality with elegant accommodations and personalized service.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32m5rRdd38TAyU0DZCqvrl288SF/uploaded-1763478427165-73xt91qv.jpg"]
  },
  robots: {
    index: true,
    follow: true
